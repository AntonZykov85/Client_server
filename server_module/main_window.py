...
from server_module.statistic import StatWindow
from server_module.config_window import ConfigWindow
from server_module.add_user import RegisterUser
from server_module.delete_user import DelUserDialog
...
class MainWindow(QMainWindow):
    def __init__(self, database, server, config):
        ...
        self.remove_btn.triggered.connect(self.delete_user)
        self.show()
    ...
    def create_users_model(self):
        ...
        list.setHorizontalHeaderLabels(
            ['User name', 'IP address', 'Port', 'Time connection'])
