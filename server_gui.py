...
def gui_create_model(database):
    ...
    list.setHorizontalHeaderLabels(['Username', 'IP address', 'Port', 'Connection time'])
...
def create_statistic_model(database):
    ...
    list.setHorizontalHeaderLabels(
        ['Username', 'Last enter', 'Message send', 'Message is received'])
...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.config_btn = QAction('Servers settings', self)
...
class ConfigWindow(QDialog):
    ...
    def initUI(self):
        ...
        self.db_path_label = QLabel('BD file path: ', self)
        ...
        self.db_path_select = QPushButton('Show...', self)
